  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-gray-700"><strong>Name:</strong> {template.name}</p>
          <p className="text-gray-700"><strong>Description:</strong> {template.description}</p>
          <p className="text-gray-700"><strong>Target Audience:</strong> {template.targetAudience}</p>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p className="text-gray-700"><strong>Primary Method:</strong> {template.monetizationStrategy.primaryMethod}</p>
          <div>
            <h4 className="font-medium mb-2">Secondary Methods</h4>
            {renderList(template.monetizationStrategy.secondaryMethods)}
          </div>
          <p className="text-gray-700"><strong>Estimated Revenue:</strong> {template.monetizationStrategy.estimatedRevenue}</p>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <p className="text-gray-700"><strong>Timeline:</strong> {template.implementation.timeline}</p>
          <div>
